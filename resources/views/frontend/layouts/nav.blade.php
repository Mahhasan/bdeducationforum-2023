            ...
            <div class="header-wrap">
                ...
                <div class="header-meta ">
                    <div class="header-btn d-none d-lg-block" style="margin-left: 0px;">
                        <a class="btn btn-primary" style="border-radius: 12px;" href="/frontend/assets/brochure/Bangladesh_Education_Forum 2023_Brochure.pdf" target="_blank">Brochure</a>
                    </div>
                    <div class="header-btn d-none d-lg-block" style="margin-left: 0px;">
...
<div class="offcanvas offcanvas-start" id="offcanvasExample">
    ...
    <div class="offcanvas-body">
        ...
        <div class="header-btn d-grid">
            <a class="btn btn-primary" style="border-radius: 12px; line-height: 46px;" href="/frontend/assets/brochure/Bangladesh_Education_Forum 2023_Brochure.pdf" target="_blank">Brochure</a>
        </div>
    </div>
    <!-- Offcanvas Body End -->
</div>
